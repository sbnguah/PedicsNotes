...
defects and syndromes. [@caputo2005] Prominent among these are Holt-Oram, Noonan,
...
high oxygen-content blood in the left atrium to the right atrium. Thus an uncomplicated ASD is
...
defects such as [ventricular septal defects](cvs-vsd.qmd). However, longstanding long-standing
...
Therefore many of these patients till now have been diagnosed incidentally when they for instance
report to the health institution for another complaint. They tend to have slender bodies, and
...
-   At the bedside pulse oximetry would likely reveal a normal SpO2 as this is an acyanotic
...
-   Cardiac catheterisation is often done in long-standing cases to detect complications possibly
    pulmonary hypertension and quantifiy the shunt volume.

## Treatment

Treatment depends on the age at diagnosis and the size of the defect. For a small defect with no
signs of heart failure, and in s child less than 3 years counselling and regular review may be what
is required. The echocardiogram should be repeated at 4 years and surgical or device closure
considered if the defect is persistent. For large defects heart failure medications can be started
as planning of immediate surgical closure is being made. Closure of the ASD is by use of a device or
...
-   Many patients with ASDs may not grow appropriately and rather become thin.
