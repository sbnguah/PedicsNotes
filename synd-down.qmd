...
+--------------------------------+--------------------------------+--------------------------------+
| **Birth – 1 Month:** *Initial  | -   Confirm karyotype          | -   Refer to cardiology if CHD |
| Screening*                     | -   Physical exam for          |     is suspected               |
|                                |     congenital anomalies       | -   Audiology                  |
...
|                                |     monitoring                 |                                |
+--------------------------------+--------------------------------+--------------------------------+
| **1 – 6 Months:** Early        | -   Growth (weight, length,    | -   Physiotherapy              |
| Development                    |     head circumference)        | -   Feeding team               |
|                                | -   Neurodevelopment           | -   Early intervention         |
|                                | -   ENT exam                   |     programs                   |
