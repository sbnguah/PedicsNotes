...
4.  ***Auscultation***: Auscultation of the heart can yield a wealth of information. It should be
    ...
    prudent to auscultate the back (between the scapullae) and over the carotids. First, the regular
    ...
    pathologic in children but an S4 is. The murmur needs to be determined if it is systolic or
    diastolic. It needs to be graded (@tbl-murmur-grades). Any radiation of the murmur should be
    determined.
