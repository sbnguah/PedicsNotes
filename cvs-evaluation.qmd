...
4.  ***Delayed milestones***: Growth failure, easy fatiguability and other genetic syndromes may
    result in delayed motor milestones in the child.
5.  ***Others***: *Fast* and sometimes *difficulty breathing* are also common presentations of CHDs.
    Some children develop *oedema*.(@fig-cvs-pedal-edema) This is predominantly seen in the faces of
    younger children and the feet of older children. Frequent *lower respiratory infection* is also
    seen in children with heart diseases, especially those associated with [heart
...
3.  ***Colour***: The skin colour of a child with a CHD could hold signs of its presence.
    *Cyanosis*, the blueish duskiness of the skin and mucous membranes can be seen in children with
    ...
    such as [Infective Endocarditis](cvs-inf-endo.qmd). *Jaundice* can be observed in patients with
...
5.  ***Respiratory signs***: Respiratory signs commonly associated with heart diseases in children
    ...
    especially true when there is associated [heart failure](cvs-heart-failure.qmd) and worsens with
...
7.  ***Blood pressure***: Low blood pressure is a late sign of circulatory failure and cardiogenic
    ...
    may indicate a [patent ductus arteriosus](cvs-pda.qmd), aortic insufficiency or an
...
4.  ***Auscultation***: Auscultation of the heart can yield a wealth of information. It should be
    ...
    ascertained. @tbl-murmur-location indicates types of murmurs, their location and likely heart
    diseases. Diastolic murmurs are difficult to appreciate for the average medical student but may
    be present in aortic regurgitation, pulmonary regurgitation, and at the cardiac apex in cases of
    [heart failure](cvs-heart-failure.qmd) secondary to a large left-to-right shunt. It is of note
    that approximately 80% of murmurs in children can be categorised as "innocent murmurs" as they
    are not associated with cardiac pathology.
...
3.  ***X-ray***: A chest x-ray is very useful in diagnosing and managing heart diseases in children.
    ...
    while decreased lung markings are often seen in [Tetralogy of Fallot](cvs-tof.qmd) and pulmonary
    stenosis. The shape of the heart is often an indicator of the underlying cardiac pathology. A
    Boot-shaped heart may indicate a [Tetralofy of Fallot](cvs-tof.qmd) (@fig-cvs-x-ray-boot-shaped)
    while a globular-shaped heart points to dilated cardiomyopathy or pericardial effusion.
    @fig-cvs-globular-heart
...
4.  ***Echocardiogram***: This is is rather old but new investigatory modality. Old because it has
    been around since the 1960s, and new because it is relatively new in Ghana. It is however a very
